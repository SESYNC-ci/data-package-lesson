...
NOTE: If you have not filled in the table attributes template completely, the `template_categorical_variables()` function will produce errors.  It also produces a useful warning message:  
...
Now we can write our metadata to a file.
