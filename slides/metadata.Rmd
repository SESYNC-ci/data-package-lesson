...
IMPORTANT: In the `personnel.txt` file, if a person has more than oen role (PI and contact), make multiple rows for this person just changing the role on each line.   
