...
Units need to be defined from a controlled vocabulary of standard units.  Use the function `view_unit_dictionary()` to view these standard units.  If you can't find your units here, they must be defined in the file `custom_units.txt` in the metadata templates folder.  

```{r, eval = FALSE, handout = 0}
view_unit_dictionary()

units <- c("number","","number","","","","","","","number","number","number",
           "number","","","","number","","decimal degrees",
