...
1) Get authentication token for DataONE (follow steps below)

2) Get a DOI from your chosen repository (if desired)
...
Paste your token in the R console, as stated in the above instructions.  
