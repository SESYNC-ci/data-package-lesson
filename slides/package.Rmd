...
You can also add scripts and derived data files to the data package.  Let's add a short script to our data package. 

```{r}
#TODO: add the example R script that produces a couple figures.   
```

===

Create a Resource Description Framework (RDF) to define the relationships between the data and metadata.  

RDF describes links between objects, and is designed to be read and understood by computers.  RDF is not designed to be read by humans, and is written in XML.  Describing your data package relationships with RDF will help with displaying your data in an online repository.  If you're interested in the details, you can read more online such as from [w3](https://www.w3schools.com/XML/xml_rdf.asp).
{:.notes}
